...
export async function POST() {
  try {
    ...
    const migrations = ['001_initial_schema.sql', '002_auth.sql', '003_leads_pipeline.sql', '004_videos_youtube_metrics.sql', '005_seguimientos.sql', '006_ideas_contenido_long_short_programado.sql', '007_onboarding_titulo_descripcion.sql', '008_onboarding_json_y_unique.sql', '009_fix_ideas_contenido_document_id_constraint.sql', '010_ideas_contenido_reels_guion.sql', '011_lead_estado_eventos.sql']
