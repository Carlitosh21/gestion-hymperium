  ...
  try {
    ...
    for (const item of ideasData) {
      try {
        ...
        const titulo = ideaParsed.titulo || ideaParsed.idea_titulo || ideaParsed.titulo_video || ideaParsed.titulo_propuesto || item.titulo_video || item.idea_titulo || 'Sin título'
